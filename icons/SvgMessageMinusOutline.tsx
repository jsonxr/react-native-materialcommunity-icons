...
export const SvgMessageMinusOutline = createSvgIcon(
  ...
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="mdi-message-minus-outline" width="24" height="24" viewBox="0 0 24 24">
